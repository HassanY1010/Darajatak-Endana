...
if (-not $isAdmin) {
    Write-Host "Elevating privileges to remove Scheduled Task..." -ForegroundColor Yellow
...
Write-Host "  UNINSTALLING DARAJATAK-ENDANA BACKUP AGENT TASK" -ForegroundColor Yellow
Write-Host "====================================================" -ForegroundColor Yellow
